...
**Windows:** [Sector-0.5.0-Setup.exe](https://github.com/mmarco2121/sectors/releases/download/v0.5.0/Sector-0.5.0-Setup.exe)
...
sudo dpkg -i Sector_0.5.0-1_amd64.deb
